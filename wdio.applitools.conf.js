const {EyesService,BrowserType,DeviceName,ScreenOrientation} = require('@applitools/eyes-webdriverio')
const eyesConfig = [EyesService,
...
exports.config = {
    ...
    services: ['chromedriver',eyesConfig],
